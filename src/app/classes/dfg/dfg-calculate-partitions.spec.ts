...
describe('Cuts Test', () => {
    it('get all cuts - loop cut possible', () => {
        ...
        const result: Array<[boolean, CutType, Arcs, Arcs]> =
        ...
        expect(result).toEqual([[true, CutType.LoopCut, arcsForA1, arcsForA2]]);
    });
    ...
    it('get all cuts - parallel cut with 2 partition options possible', () => {
        ...
        expect(result).toEqual([
            [true, CutType.ParallelCut, arcsForA1, arcsForA2],
            [true, CutType.ParallelCut, arcsForA2, arcsForA1],
        ]);
    });
    ...
    it('get all cuts - 3 exclusive cuts with 2 partition options possible', () => {
        ...
        expect(result).toEqual([
            [true, CutType.ExclusiveCut, arcsForA1_1, arcsForA2_1],
            [true, CutType.ExclusiveCut, arcsForA1_2, arcsForA2_2],
            [true, CutType.ExclusiveCut, arcsForA1_3, arcsForA2_3],
            [true, CutType.ExclusiveCut, arcsForA2_1, arcsForA1_1],
            [true, CutType.ExclusiveCut, arcsForA2_2, arcsForA1_2],
            [true, CutType.ExclusiveCut, arcsForA2_3, arcsForA1_3],
        ]);
    });
    ...
    it('get all cuts - sequence cut possible and loop cut seems to be possible', () => {
        ...
        expect(result).toEqual([
            [true, CutType.SequenceCut, arcsForA1, arcsForA2],
        ]);
    });
    ...
    it('get all cuts - exclusive cut with 2 partition options possible and sequence cut + loop cut seems to be possible', () => {
        ...
        expect(result).toEqual([
            [true, CutType.ExclusiveCut, arcsForA1, arcsForA2],
            [true, CutType.ExclusiveCut, arcsForA2, arcsForA1],
        ]);
    });
    ...
    it('get all cuts - 3 sequence cuts possible', () => {
        ...
        expect(result).toEqual([
            [true, CutType.SequenceCut, arcsForA1_1, arcsForA2_1],
            [true, CutType.SequenceCut, arcsForA1_2, arcsForA2_2],
            [true, CutType.SequenceCut, arcsForA1_3, arcsForA2_3],
        ]);
    });
